# asset:native_append_effect@1.1.0
...
Supported adapters: freshdesk, gorgias, helpscout, intercom, reamaze, zendesk, zoho_desk. Scope and boundaries are those stated in this description, in the parameters, and in the native effects / protection obligations the call returns; other operations in the capability table are not admitted by association.
...
Explicit parameter example for adapter `intercom`:
...
```json
{
  ...
  "protected_value": "contact@example.org"
}
```
